package br.com.pupposoft.poc.monitoriamento.carrinhocompra.config.logger;

import static br.com.pupposoft.poc.monitoriamento.carrinhocompra.config.logger.LogFields.CLASS;
import static br.com.pupposoft.poc.monitoriamento.carrinhocompra.config.logger.LogFields.CLASS_METHOD;
import static br.com.pupposoft.poc.monitoriamento.carrinhocompra.config.logger.LogFields.ELAPSED_TIME;
import static br.com.pupposoft.poc.monitoriamento.carrinhocompra.config.logger.LogFields.EXEC_END;
import static br.com.pupposoft.poc.monitoriamento.carrinhocompra.config.logger.LogFields.EXEC_START;
import static br.com.pupposoft.poc.monitoriamento.carrinhocompra.config.logger.LogFields.REQUEST_BODY;
import static br.com.pupposoft.poc.monitoriamento.carrinhocompra.config.logger.LogFields.REQUEST_HEADERS;
import static br.com.pupposoft.poc.monitoriamento.carrinhocompra.config.logger.LogFields.REQUEST_HTTP_METHOD;
import static br.com.pupposoft.poc.monitoriamento.carrinhocompra.config.logger.LogFields.REQUEST_PARAMS;
import static br.com.pupposoft.poc.monitoriamento.carrinhocompra.config.logger.LogFields.REQUEST_PATH;
import static br.com.pupposoft.poc.monitoriamento.carrinhocompra.config.logger.LogFields.REQUEST_USER_AGENT;
import static br.com.pupposoft.poc.monitoriamento.carrinhocompra.config.logger.LogFields.RESPONSE_BODY;
import static br.com.pupposoft.poc.monitoriamento.carrinhocompra.config.logger.LogFields.RESPONSE_HEADERS;
import static br.com.pupposoft.poc.monitoriamento.carrinhocompra.config.logger.LogFields.RESPONSE_STATUS_CODE;
import static br.com.pupposoft.poc.monitoriamento.carrinhocompra.config.logger.LogFields.TRACE_ID;
